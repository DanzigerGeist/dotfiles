return {
  ...
  config = function(_, _)
    ...
    wk.add({
      ...
      { "<leader>it",       "<cmd>ToggleTerm direction=float<CR>",                           desc = "Terminal" },
      ...
      -- Tabs
      { "<leader>t",        group = "Tabs" },
      { "<leader>tl",       "<cmd>tabs<CR>",                                                 desc = "List Opened Tabs" },
      { "<leader>tN",       "<cmd>tabnew<CR>",                                               desc = "New Tab" },
      { "<leader>to",       "<cmd>tabnew %<CR>",                                             desc = "Open Current Buffer in New Tab" },
      { "<leader>tq",       "<cmd>tabclose<CR>",                                             desc = "Close Tab" },
      { "<leader>t<Left>",  "<cmd>tabp<CR>",                                                 desc = "Previous Tab" },
      { "<leader>t<Right>", "<cmd>tabn<CR>",                                                 desc = "Next Tab" },
      ...
      { "<leader>vke",      "<cmd>e ~/.config/nvim/lua/plugins/keybindings.lua<CR>",         desc = "Edit" },
